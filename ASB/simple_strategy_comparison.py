    ...
    def _simulate_single_strategy(self, stock_path, volume_path, avg_price_path, 
        ...
        for t in range(self.N):
            ...
            if t >= self.early_exercise_start:
                ...
                terminal_penalty = 2e-7 * shares_remaining ** 2
        ...
        final_pnl = self.F - total_cost if exercise_day is None else daily_data['pnl_values'][-1]
...
def main():
    ...
    results = comparator.simulate_strategies(path_idx=2)
